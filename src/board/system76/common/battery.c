...
config_t battery_start_threshold = {
    .config_short = "Battery Charing Start Threshold",
    .config_desc = "Capacity at which the battery will start charging",
    .value = {
        .min_value = 0,
        .max_value = 99,
...
config_t battery_stop_threshold = {
    ...
    .config_desc = "Capacity at which the battery will stop charging",
    .value = {
        .min_value = 1,
        .max_value = 100,
